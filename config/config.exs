...
config :band_of_the_week,
  ecto_repos: [BandOfTheWeek.Repo]

# Configures the endpoint
config :band_of_the_week, BandOfTheWeekWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: BandOfTheWeekWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: BandOfTheWeek.PubSub,
  live_view: [signing_salt: "dg3Sl3em"]
...
config :band_of_the_week, BandOfTheWeek.Mailer, adapter: Swoosh.Adapters.Local
